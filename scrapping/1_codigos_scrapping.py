...
for anio in range(inicio, fin+1):
    ...
    while i<10000:
        ...
        if(nombre!="None"):
            ...
            i = i+1 if (i%500==0) else ((i//500)+1)*500
        '''
...
#Despues de eso invertirlo en https://www.online-utility.org/text/sort.jsp con invert sort
#O en http://spellbackwards.com/ con reverse words